...
namespace KoboWorklist
{
    public partial class App : Application
    {
        ...
        Timer _hourtimer = new Timer(3600000); // 1 час
        private static readonly ILog log = LogManager.GetLogger(typeof(App));
        public static string DatabasePath = "WorklistItems.db";
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            _hourtimer.Elapsed += (sender, e) => DeleteOlderThanHours(2);
        ...
        private async void OnTimerElapsed(object sender, ElapsedEventArgs e)
        {
            ...
            try
            {
                ...
                var worklistProvider = new WorklistItemsProvider(DatabasePath, configuration);
        ...
        public static void DeleteOlderThanHours(int hours)
        {
            ...
            WHERE datetime(CreatedAt) < datetime('now', '-{hours} hours')";
            command.ExecuteNonQuery();
        }
